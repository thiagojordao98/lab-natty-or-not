...
- **Conceitos de IAs Generativas**:
  - Midjourney (geração de imagens)
  - DALL-E 3 (síntese de imagem)
  - Stable Diffusion (difusão latente)
  - Leonardo.AI (criação artística)
- **Lógica de Gamificação** - Sistema de pontuação e desafios
- **Interface CLI Interativa** - Menu e feedback visual

## 🧐 Processo de Criação

1. **Análise do Tema**: Pesquisei as características que diferenciam criações humanas de geradas por IA
   - Imperfeições naturais vs precisão matemática
   - Variação orgânica vs uniformidade de IA
   - Expressão genuína vs perfeição técnica

2. **Desenvolvimento da Mecânica**:
   - Criei 8 desafios baseados em casos reais
   - Misturei dificuldades (Fácil, Médio, Difícil)
   - Adicionei sistema de pontuação
   - Implementei dicas progressivas

3. **Conteúdo Educativo**:
   - Documentei ferramentas reais de IA
   - Listei indicadores de autenticidade
   - Incluí reflexão sobre futuro IA+Humano

4. **Experiência do Usuário**:
   - Menu intuitivo e bem estruturado
   - Feedback imediato
   - Estatísticas de desempenho
   - ASCII art para melhor apresentação

## 🚀 Resultados

✅ **Jogo Totalmente Funcional**: 8 desafios realistas com dificuldades variadas

✅ **Educativo**: Ensina sobre características de IA enquanto diverte

✅ **Sistema de Pontuação**: Acompanha progresso do jogador

✅ **Conteúdo Robusto**: Informações sobre ferramentas reais de IA

✅ **Interface Amigável**: Menus claros com emojis e formatação

### Recursos Principais:
- **Desafios Aleatórios**: 8 cenários diferentes (artes, fotos, designs)
- **Sistema de Dicas**: Ajuda progressiva sem spoilar a resposta
- **Estatísticas**: Acompanhe sua taxa de acerto
- **Conteúdo Educativo**: Aprenda sobre IAs geradoras reais
- **Gamificação**: Pontos, desafios e progresso
...
**"Natty or Not" reimaginado para a era das IAs Generativas**

Este projeto consegue capturar a essência do desafio proposto pelo Lab:

1. **Questiona a Autenticidade**: Cada desafio força o jogador a pensar criticamente sobre o que é "real"

2. **Explora Limites**: Mostra que os limites entre humano e IA estão cada vez mais nebulosos

3. **Educação Prática**: Não apenas ensina sobre IA, mas desenvolve skills de detecção

4. **Temática Envolvente**: A gamificação mantém engajamento ao mesmo tempo que educa

5. **Relevância Atual**: Aborda um problema real e crescente - deepfakes e conteúdo de IA indistinguível

**O Desafio Real**: Não é apenas "adivinhar", é entender:
- Como IAs criam padrões
- Onde estão as "falhas" que revelam origem
- Como a tecnologia está impactando arte e criatividade
- O futuro onde IA + Humano criam juntos
